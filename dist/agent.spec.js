...
describe("token created agent", function () {
    var handleTransaction;
    var createTxEventWithToken = function () { return (0, forta_agent_1.createTransactionEvent)({
        transaction: {
    ...
    describe("token event", function () {
        it("coin symbol is similar", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txEvent, findings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txEvent = createTxEventWithToken();
                        return [4 /*yield*/, handleTransaction(txEvent)];
                    case 1:
                        findings = _a.sent();
                        expect(findings[0].metadata.symbol).toBe("Cake");
                        return [2 /*return*/];
                }
            });
        }); });
